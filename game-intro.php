        ...
        <div class="row">
         ...
         <div class="row padding-right padding-left margin-bottom-2">
            ...
            <div class="small-12 small-centered medium-7 medium-uncentered columns small-text-center medium-text-left">
                <h5 class="margin-top"><span class="waffle">Instructions</span></h5>
                <p>
                ...
                <a href="game-play.php?v=1" role="button" class="pageLink button right margin-right padding-top">Start Game</a>
            </div>
        </div>
    </div>
